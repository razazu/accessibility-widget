...
function useAccessibility(storageKey = "accessibility-settings") {
  ...
  const updateSetting = (0, import_react.useCallback)(
    (key, value) => {
  ...
  const increaseFontSize = (0, import_react.useCallback)(() => {
    setSettings((prev) => ({
      ...prev,
      fontSize: Math.min(prev.fontSize + 1, 3)
    }));
  }, []);
  const decreaseFontSize = (0, import_react.useCallback)(() => {
    setSettings((prev) => ({
      ...prev,
      fontSize: Math.max(prev.fontSize - 1, 0)
    }));
  }, []);
  const toggleSetting = (0, import_react.useCallback)(
    (key) => {
...
var AccessibilityIcon = ({ size = 24, className }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    width: size,
    height: size,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "m9 20 3-6 3 6" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "m6 8 6 2 6-2" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M12 10v4" })
    ]
  }
);
var CloseIcon = ({ size = 24, className }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    width: size,
    height: size,
...
var FontSizeIcon = ({ size = 24, className }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    width: size,
    height: size,
    ...
    className,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x: "4", y: "16", fontSize: "12", fill: "currentColor", stroke: "none", children: "A" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x: "14", y: "18", fontSize: "16", fill: "currentColor", stroke: "none", children: "A" })
    ]
  }
);
var ContrastIcon = ({ size = 24, className }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    width: size,
    height: size,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M12 2a10 10 0 0 1 0 20", fill: "currentColor" })
    ]
  }
);
var LinkIcon = ({ size = 24, className }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    width: size,
    height: size,
...
var PauseIcon = ({ size = 24, className }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    width: size,
    height: size,
...
var BookIcon = ({ size = 24, className }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    width: size,
    height: size,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("line", { x1: "8", y1: "7", x2: "16", y2: "7" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("line", { x1: "8", y1: "11", x2: "14", y2: "11" })
    ]
  }
);
var TextIcon = ({ size = 24, className }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    width: size,
    height: size,
...
var ResetIcon = ({ size = 24, className }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    width: size,
    height: size,
...
var MinusIcon = ({ size = 24, className }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
  "svg",
  {
    width: size,
    height: size,
...
var PlusIcon = ({ size = 24, className }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    width: size,
    height: size,
...
var SettingsIcon = ({ size = 24, className }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
  "svg",
  {
    width: size,
    height: size,
...
var CheckIcon = ({ size = 24, className }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
  "svg",
  {
    width: size,
    height: size,
...
function AccessibilityWidget({
  ...
  const [customization, setCustomization] = (0, import_react2.useState)({
    ...defaultCustomization,
    color: primaryColor,
    positionDesktop: position,
    positionMobile: position
  });
  const [tempCustomization, setTempCustomization] = (0, import_react2.useState)(customization);
  const [isMobile, setIsMobile] = (0, import_react2.useState)(false);
  const [stylesInjected, setStylesInjected] = (0, import_react2.useState)(false);
  const {
    settings,
    isLoaded,
    resetSettings,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      "button",
      {
        ...
        children: isOpen ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CloseIcon, { size: 24 }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(AccessibilityIcon, { size: 28 })
      }
    ),
    isOpen && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
      "div",
      {
        ...
        "aria-label": t.title,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-widget-header", style: { background: `linear-gradient(135deg, ${customization.color}, ${customization.color}dd)` }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              "button",
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SettingsIcon, { size: 18 })
              }
            ),
            branding?.logoUrl ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-widget-header-brand", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "img",
                {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "a11y-widget-header-subtitle", children: "Accessibility" })
            ] }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { className: "a11y-widget-title", children: t.title }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              "button",
              {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-widget-content", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-widget-option", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "a11y-widget-option-label", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(FontSizeIcon, { size: 20, className: "a11y-widget-option-icon" }),
                t.fontSize
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-widget-font-controls", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(MinusIcon, { size: 16 })
                  }
                ),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "a11y-widget-font-level", children: settings.fontSize }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                  "button",
                  {
                    className: "a11y-widget-font-btn",
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PlusIcon, { size: 16 })
                  }
                )
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-widget-option", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "a11y-widget-option-label", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ContrastIcon, { size: 20, className: "a11y-widget-option-icon" }),
                t.highContrast
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "button",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-widget-option", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "a11y-widget-option-label", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(LinkIcon, { size: 20, className: "a11y-widget-option-icon" }),
                t.highlightLinks
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "button",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-widget-option", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "a11y-widget-option-label", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PauseIcon, { size: 20, className: "a11y-widget-option-icon" }),
                t.stopAnimations
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "button",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-widget-option", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "a11y-widget-option-label", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(BookIcon, { size: 20, className: "a11y-widget-option-icon" }),
                t.readingMode
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "button",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-widget-option", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "a11y-widget-option-label", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(TextIcon, { size: 20, className: "a11y-widget-option-icon" }),
                t.dyslexiaFont
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "button",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { className: "a11y-widget-reset", onClick: resetSettings, children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ResetIcon, { size: 18 }),
              t.reset
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "a11y-widget-disclaimer", children: t.disclaimer }),
            branding && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
              "a",
              {
    ...
    showSettings && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "a11y-settings-overlay", onClick: handleCancelSettings, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-settings-modal", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-settings-header", style: { background: `linear-gradient(135deg, ${tempCustomization.color}, ${tempCustomization.color}dd)` }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { className: "a11y-settings-title", children: t.widgetSettings }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { className: "a11y-settings-close", onClick: handleCancelSettings, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CloseIcon, { size: 20 }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-settings-content", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-settings-section", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { className: "a11y-settings-label", children: t.buttonColor }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "a11y-color-picker", children: COLORS.map((color) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "button",
            {
              ...
              "aria-label": color,
              children: tempCustomization.color === color && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CheckIcon, { size: 16 })
            },
            color
          )) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-settings-section", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { className: "a11y-settings-label", children: t.positionDesktop }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "a11y-position-grid", children: positionOptions.map((opt) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "button",
            {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-settings-section", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { className: "a11y-settings-label", children: t.positionMobile }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "a11y-position-grid", children: positionOptions.map((opt) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "button",
            {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "a11y-settings-actions", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { className: "a11y-settings-save", onClick: handleSaveSettings, style: { background: tempCustomization.color }, children: t.save }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { className: "a11y-settings-cancel", onClick: handleCancelSettings, children: t.cancel })
        ] })
      ] })
    ] }) })
  ] });
